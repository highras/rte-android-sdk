...
//        isRunning = false;
    ...
    public void run() {
        try {
            ...
            release();
            if (LDRecordAudio.getInstance().audioAction != null){
                LDRecordAudio.getInstance().audioAction.broadFinish();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
public class LDRecordAudio {
    BluetoothUtil bluetoothUtil;
    AudioManager mAudioManager;

    private static LDRecordAudio instance = null;
    ...
    public static LDRecordAudio getInstance() {
        if (instance == null) {
            synchronized (LDRecordAudio.class) {
                if (instance == null) {
                    instance = new LDRecordAudio();
                }
            }
        }
        return instance;
    ...
    public LiveDataStruct.RecordAudioStruct getAudioInfo() {
    ...
    public LiveDataStruct.RecordAudioStruct getAudioInfo(File file) {
        ByteArrayOutputStream os = new ByteArrayOutputStream();
        LiveDataStruct.RecordAudioStruct tt = new LiveDataStruct.RecordAudioStruct();
    ...
    public LiveDataStruct.RecordAudioStruct stopRecord() {
        if (mRecorder == null)
            return null;
        try {
            mRecorder.setOnErrorListener(null);
